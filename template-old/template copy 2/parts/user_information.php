...
//         'value' => '<div class="mangopay-headlines"><span class="img_tip wcfmfa fa-question" data-tip="' . $bank_details_hints . '" data-hasqtip="50" aria-describedby="qtip-50"></span><h3><strong>' . __('User Information.', 'wc-multivendor-marketplace') . '</strong></h3></div>',
//     ),
